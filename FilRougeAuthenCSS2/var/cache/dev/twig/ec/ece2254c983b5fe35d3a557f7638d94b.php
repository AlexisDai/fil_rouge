...
class __TwigTemplate_0517264a48084afa0a687bc869f99761 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "\" class=\"btn btn-outline-info pr-2\">show</a>
                    <a href=\"";
            // line 27
            ...
            echo "\" class=\"btn btn-outline-info pr-2\">edit</a>
                </td>
            </tr>
        ";
    ...
    <a href=\"";
        ...
        echo "\" class=\"btn btn-outline-success\">Create new</a>
";
...
{% block login %}
    ...
    <table class=\"table\">
        ...
        {% for user in users %}
            <tr>
                ...
                <td>{{ user.password }}</td>
                <td>
                    <a href=\"{{ path('app_user_show', {'id': user.id}) }}\" class=\"btn btn-outline-info pr-2\">show</a>
                    <a href=\"{{ path('app_user_edit', {'id': user.id}) }}\" class=\"btn btn-outline-info pr-2\">edit</a>
                </td>
            </tr>
        {% else %}
            <tr>
    ...
    <a href=\"{{ path('app_user_new') }}\" class=\"btn btn-outline-success\">Create new</a>
{% endblock %}
", "user/index.html.twig", "/home/florianptf/Bureau/FilRougeAuthenCSS/templates/user/index.html.twig");
    }
}
