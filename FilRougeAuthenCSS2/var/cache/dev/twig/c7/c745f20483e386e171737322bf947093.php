...
/* user/edit.html.twig */
class __TwigTemplate_cf1d4162de5300925af65c07e4434abc extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN")) {
            ...
            echo "\" class=\"btn btn-outline-warning mt-2\">back to list</a>
";
        } else {
            // line 29
            echo "    <a href=\"";
...
";
    ...
    {
        return array (  115 => 32,  112 => 31,  106 => 29,  100 => 27,  98 => 26,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% if is_granted('ROLE_ADMIN') %}
    <a href=\"{{ path('app_user_index') }}\" class=\"btn btn-outline-warning mt-2\">back to list</a>
{% else %}
    <a href=\"{{ path('rubrique') }}\" class=\"btn btn-outline-warning mt-2\">back to list</a>
{% endif %}

    {{ include('user/_delete_form.html.twig') }}
{% endblock %}
", "user/edit.html.twig", "/home/florianptf/Bureau/FilRougeAuthenCSS/templates/user/edit.html.twig");
    }
}
