...
class ProduitController extends AbstractController
{
    ...
    public function new(Request $request, ProduitRepository $produitRepository, RubriqueRepository $repo): Response
    {
        $produit = new Produit();
    ...
    public function edit(Request $request, Produit $produit, ProduitRepository $produitRepository, RubriqueRepository $repo): Response
    {
        $form = $this->createForm(ProduitType::class, $produit);
        $form->handleRequest($request);
