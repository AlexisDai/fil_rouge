...
class __TwigTemplate_7466934aeaccc47bce95d8f4ab67432a extends Template
{
    ...
    <a href=\"";
        // line 10
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_produit_show", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["produit"]) || array_key_exists("produit", $context) ? $context["produit"] : (function () { throw new RuntimeError('Variable "produit" does not exist.', 10, $this->source); })()), "rubrique", [], "any", false, false, false, 10), "id", [], "any", false, false, false, 10)]), "html", null, true);
        echo "\">Retour</a>
                                                     ";
        // line 12
        echo "
...
";
    ...
    {
        return array (  104 => 13,  101 => 12,  97 => 10,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block produit %}
    ...
    <a href=\"{{ path('app_produit_show', {'id': produit.rubrique.id}) }}\">Retour</a>
