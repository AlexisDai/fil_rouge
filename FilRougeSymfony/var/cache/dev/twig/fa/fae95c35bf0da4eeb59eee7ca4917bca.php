...
class __TwigTemplate_84f6cc03fc94bdab963359c0d13cb8e9 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {{ form_widget(form) }}
    <button class=\"btn-primary\">{{ button_label|default('Save') }}</button>
{{ form_end(form) }}
", "user/_form.html.twig", "/home/florianptf/Bureau/FilRougeAuthenCSS/templates/user/_form.html.twig");
    }
}
